...
namespace NSPC.Data.Migrations
{
    ...
    [Migration("20240911132439_createTableSaleOrder")]
    partial class createTableSaleOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.QuanLyPhieu.mk_PhieuItem", b =>
                {
                    ...
                    b.Property<Guid?>("sm_SaleOrdersId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("sm_SaleOrdersId");

                    b.ToTable("mk_PhieuItem");
                });

            modelBuilder.Entity("NSPC.Data.Data.Entity.QuanLyPhieu.sm_SaleOrders", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("mk_DuAnId");

                    b.ToTable("sm_SaleOrders");
                });
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.StockTransaction.sm_Stock_Transaction", b =>
                {
                    ...
                    b.Property<int?>("ExportInventory")
                        .HasColumnType("integer");

                    b.Property<int?>("InventoryDecreased")
                        .HasColumnType("integer");

                    b.Property<int?>("InventoryIncreased")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RecieptInventory")
                        .HasColumnType("integer");

                    b.Property<decimal?>("TotalExportInventory")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.QuanLyPhieu.mk_PhieuItem", b =>
                {
                    ...
                    b.HasOne("NSPC.Data.Data.Entity.QuanLyPhieu.sm_SaleOrders", null)
                        .WithMany("ProductItem")
                        .HasForeignKey("sm_SaleOrdersId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.Quotation.sm_Quotation", b =>
                {
                    b.HasOne("NSPC.Data.Data.Entity.DuAn.mk_DuAn", null)
