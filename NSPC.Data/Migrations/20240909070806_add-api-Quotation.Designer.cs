...
namespace NSPC.Data.Migrations
{
    ...
    [Migration("20240909070806_add-api-Quotation")]
    partial class addapiQuotation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.PurchaseOrder.sm_PurchaseOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("InvoiceRecieptAddress")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PackageAndDeliveryType")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal?>("TotalDiscountsAccount")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("TotalRecieptInventory")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.PurchaseOrder.sm_PurchaseOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.QuanLyKho.mk_QuanLyPhieu", b =>
                {
                    ...
                    b.Property<string>("ReceiveInventoryStatus")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.Quotation.sm_QuotationItem", b =>
                {
                    ...
                    b.Property<Guid?>("sm_QuotationId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("sm_QuotationId");
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.StockTransaction.sm_Stock_Transaction", b =>
                {
                    ...
                    b.Property<int?>("DifferentAmount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.PurchaseOrder.sm_PurchaseOrderItem", b =>
                {
                    ...
                    b.HasOne("NSPC.Data.Data.Entity.PurchaseOrder.sm_PurchaseOrder", "Sm_PurchaseOrder")
            ...
            modelBuilder.Entity("NSPC.Data.Data.Entity.Quotation.sm_QuotationItem", b =>
                {
                    b.HasOne("NSPC.Data.Data.Entity.Quotation.sm_Quotation", null)
                        .WithMany("QuotationItem")
                        .HasForeignKey("sm_QuotationId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
